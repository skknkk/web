...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'Spam', description: 'Причина блокировки' }),
    (0, sequelize_typescript_1.Column)({ type: sequelize_typescript_1.DataType.STRING, allowNull: true }),
    __metadata("design:type", String)
], User.prototype, "banReason", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ type: [roles_model_1.Role], description: 'Роли пользователя' }),
    (0, sequelize_typescript_1.BelongsToMany)(() => roles_model_1.Role, () => user_roles_model_1.UserRoles),
    __metadata("design:type", Array)
], User.prototype, "roles", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ type: basket_model_1.Basket, description: 'Корзина пользователя' }),
