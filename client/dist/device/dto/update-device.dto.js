...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 49990, description: 'Цена товара' }),
    (0, class_validator_1.IsNumber)({}, { message: 'Должно быть целым числом' }),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", Number)
], UpdateDeviceDto.prototype, "price", void 0);
__decorate([
    ...
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", Number)
], UpdateDeviceDto.prototype, "brandId", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: 1, description: 'Идентификатор типа' }),
    (0, class_validator_1.IsInt)({ message: 'Должно быть целым числом' }),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", Number)
], UpdateDeviceDto.prototype, "typeId", void 0);
