...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'Смартфоны', description: 'Название типа' }),
...
], Type.prototype, "device", void 0);
Type = __decorate([
    (0, sequelize_typescript_1.Table)({ tableName: 'type', createdAt: false, updatedAt: false })
], Type);
exports.Type = Type;
