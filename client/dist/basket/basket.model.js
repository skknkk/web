...
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Список товаров в корзине', type: () => [device_model_1.Device] }),
    (0, sequelize_typescript_1.BelongsToMany)(() => device_model_1.Device, () => basket_device_model_1.BasketDevice),
    __metadata("design:type", Array)
], Basket.prototype, "devices", void 0);
Basket = __decorate([
    (0, sequelize_typescript_1.Table)({ tableName: 'baskets', createdAt: false, updatedAt: false })
], Basket);
