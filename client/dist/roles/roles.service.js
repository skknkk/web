...
let RolesService = class RolesService {
    ...
    async createRole(dto) {
        ...
        if (check) {
            throw new common_1.HttpException('Такая роль уже существует', common_1.HttpStatus.NOT_FOUND);
        }
    ...
    async deleteRole(deleteRoleDto) {
    ...
    async updateRole(updateRoleDto, roleValue) {
